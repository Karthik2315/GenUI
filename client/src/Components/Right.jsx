  ...
  return (
    ...
    {!outputScreen ? (
      ...
      {tab === 1 ? (
        ...
        <div className='flex gap-5'>
          <button className='flex justify-center gap-1 text-black items-center text-sm bg-gradient-to-r from-[#F7F8F8] to-[#ACBB78] rounded-2xl w-[150px] h-[30px] hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer'><ExternalLink className='size-4 ' />Open in New Tab</button>
          <button className='flex gap-1 text-black items-center text-sm bg-gradient-to-r from-[#F7F8F8] to-[#ACBB78] rounded-2xl px-4 w-[100px] h-[30px] hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer'  ><RotateCcw className='size-4' />Refresh</button>
        </div>
          </>
        )
      }
        ...
        <div style={{height:'450px'}} className='mt-5 flex p-2 bg-black rounded-2xl'>
          ...
          <div className='bg-white h-[450px] mt-5 rounded-2xl'>
            <iframe  srcDoc={code} className='w-full h-full text-black bg-white flex justify-center items-center'></iframe>
          </div>
        )
        }
      </div>
